        ...
        while self.answer != self.guess:
            ...
            try:
                self.guess = int(input(
                    colored("[INPUT NEEDED]", 'yellow') + " {attempts} guesses left // Enter a number: ".format(
...
""")
    ...
    def confirm_choice(self):
        try:
            choice = input("Please enter " + colored("[Y]", 'green') + " to confirm or " + colored("[N]",
                                                                                                   'red') + " to choose a new difficulty setting.\n>>> ")
